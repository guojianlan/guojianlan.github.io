        ...
        if (H && C.swipeReset(), !b.onlyExternal && C.isTouched) {
            ...
            if (C.isMoved = !1, b.freeMode) {
                if (b.freeModeFluid) {
                    ...
                    - g > k && (b.momentumBounce && C.support.transitions ? ( - m > k + g && (k = - g - m), h = - g, l = !0, $ = !0)  : k = - g),
    ...
    function u(a, c, d) {
        function e() {
            ...
            k ? (C.setWrapperTranslate(Math.round(h)), C._DOMAnimating = !0, window.setTimeout(function () {
                e()
            }, 1000 / 60))  : (b.onSlideChangeEnd && ('to' === c ? d.runCallbacks === !0 && C.fireCallback(b.onSlideChangeEnd, C)  : C.fireCallback(b.onSlideChangeEnd, C)), C.setWrapperTranslate(a), C._DOMAnimating = !1)
        }
        ...
        C.init = function (a, c) {
            ...
            if (d !== C.width || e !== C.height || a) {
                ...
                E = M ? i : j;
                    ...
                    for (f = M ? C.width / b.slidesPerView : C.width, b.roundLengths && (f = Math.round(f)), i = M ? C.slides.length * f : C.width, E = M ? f : g, b.offsetSlidesBefore > 0 && (M ? C.wrapperLeft = E * b.offsetSlidesBefore : C.wrapperTop = E * b.offsetSlidesBefore), b.offsetSlidesAfter > 0 && (M ? C.wrapperRight = E * b.offsetSlidesAfter : C.wrapperBottom = E * b.offsetSlidesAfter), b.offsetPxBefore > 0 && (M ? C.wrapperLeft = b.offsetPxBefore : C.wrapperTop = b.offsetPxBefore), b.offsetPxAfter > 0 && (M ? C.wrapperRight = b.offsetPxAfter : C.wrapperBottom = b.offsetPxAfter), b.centeredSlides && (M ? (C.wrapperLeft = (I - E) / 2, C.wrapperRight = (I - E) / 2)  : (C.wrapperTop = (I - E) / 2, C.wrapperBottom = (I - E) / 2)), M ? (C.wrapperLeft > 0 && (m.style.paddingLeft = C.wrapperLeft + 'px'), C.wrapperRight > 0 && (m.style.paddingRight = C.wrapperRight + 'px'))  : (C.wrapperTop > 0 && (m.style.paddingTop = C.wrapperTop + 'px'), C.wrapperBottom > 0 && (m.style.paddingBottom = C.wrapperBottom + 'px')), F = M ? i + C.wrapperRight + C.wrapperLeft : j + C.wrapperTop + C.wrapperBottom, b.cssWidthAndHeight || (parseFloat(i) > 0 && (m.style.width = i + 'px'), parseFloat(j) > 0 && (m.style.height = j + 'px')), k = 0, C.snapGrid = [
                    ], C.slidesGrid = [
                    ], l = 0; l < C.slides.length; l++) C.snapGrid.push(k),
                    C.slidesGrid.push(k),
                    k += E,
