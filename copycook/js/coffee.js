...
;(function($){
  // 利用zpeto的animate的动画-css3的动画-easing为了css3的easing(zpeto没有提供easing的扩展)
	...
	$.fn.coffee.defaults = {
		...
		steamFlyTime		  : 3000 , /*Steam飞行的时间,单位 ms 。（决定steam飞行速度的快慢）*/
		steamInterval	    : 1000 ,  /*制造Steam时间间隔,单位 ms.*/
		steamMaxSize		  : 20 ,   /*随即获取漂浮物的字体大小*/
		steamHeight	  	  : 200,   /*飞行体的高度*/
		steamWidth	      : 40    /*飞行体的宽度*/
	};
	$.fn.coffee.version = '2.0.1'; // 更新为音符的悬浮
})(Zepto);
